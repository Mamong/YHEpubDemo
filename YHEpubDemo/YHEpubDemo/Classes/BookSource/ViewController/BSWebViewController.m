...
{
    [self.wkWebView.configuration.websiteDataStore.httpCookieStore getAllCookies:^(NSArray<NSHTTPCookie *> * cookies) {
        [[FileDownloader shared] setCookie:cookies forUrl:url];
        FileItem *file = [[FileItem alloc] init];
        file.name = name;
        file.downloadURL = url.absoluteString;
        [[FileDownloader shared] downloadFile:file];
    }];
...
- (nullable WKWebView *)webView:(WKWebView *)webView createWebViewWithConfiguration:(WKWebViewConfiguration *)configuration forNavigationAction:(WKNavigationAction *)navigationAction windowFeatures:(WKWindowFeatures *)windowFeatures
{
    ...
    {
        BSWebViewController* controller = [[BSWebViewController alloc] init];
